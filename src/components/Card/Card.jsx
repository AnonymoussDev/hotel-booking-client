...
const Card = ({ option, data, keys, deleteOption, revertOption, deleteFlag, callbackKeyWord }) => {
    ...
    function formatHeader(text) {
        ...
        // Tách các từ dựa trên các chữ cái viết hoa hoặc theo dấu cách
        const words = text.replace(/([a-z])([A-Z])/g, '$1 $2').split(' ');

        // Chuyển đổi chữ cái đầu của từ đầu tiên thành chữ hoa và các từ còn lại viết thường
                                                            ...
                                                            if (value) {
                                                                const result = await dispatch(
                                                                    ...
                                                                    .then((originalPromiseResult) => {
                                                                        console.log(originalPromiseResult);
                                                                        if (
                                                                            originalPromiseResult.status.code === '00'
                                                                        ) {
                                                                            Swal.fire(
