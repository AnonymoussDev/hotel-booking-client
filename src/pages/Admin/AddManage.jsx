...
import { fetchCreateRoom } from 'src/stores/roomSlice/roomSlice';
import { fetchCreateHotelServices, fetchGetHotelServicesAdmin } from 'src/stores/hotelServiceSlice/hotelServiceSlice';
import { fetchCreateProduct } from 'src/stores/productSlice/productSlice';
import { fetchCreateSale } from 'src/stores/saleSlice/saleSlice';
// import { fetchCreatePost } from 'src/stores/postSlice/postSlice';
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            setData((prevState) => {
                                                                ...
                                                                setVirtualImg(URL.createObjectURL(e.target.files[0]));
                                                                return prevState;
                                                            });
                                                        }}
                                                    />
                                                        ...
                                                        <div className="image-uploads-imgs">
                                                            {virtualImg && (
                                                                <div className="image-uploads-img">
                                                                    ...
                                                                    {virtualImg != 'assets/img/icons/upload.svg' && (
