...
import { fetchGetAvailableRooms, setStoreRooms } from 'src/stores/roomSlice/roomSlice';
        ...
        (async () => {
            await dispatch(
                ...
                .then((result) => {
                    ...
                    dispatch(setStoreRooms(result.data.items));
                            ...
                            rooms.map((room) => {
                                return (
                                    <div key={room.id} className="col-lg-4 col-md-6">
                                        <div style={{ boxShadow: '0 0 10px #8888' }} className="room-item">
                                            <OwlCarousel
                                                style={{
                                                    // position: "absolute",
                                                    top: '0',
